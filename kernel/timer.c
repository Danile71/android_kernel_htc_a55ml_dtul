...
void add_timer_on(struct timer_list *timer, int cpu)
{
	...
	{
		printk(KERN_EMERG "MTK debug for add_timer_on with next=MULL, timer=%p, timer->function=%p\n", timer, timer->function);
		BUG();
	}
	timer_stats_timer_set_start_info(timer);
