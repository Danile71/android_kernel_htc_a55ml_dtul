...
#ifdef CONFIG_HTC_REBOOT_REASON_INFORMATION
        htc_reboot_reason_update_by_cmd("power_off");
#endif
...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_ett_settings msdc0_ett_settings[] = {
        ...
        { MSDC_HS200_MODE, 0xb0,  (0x7 << 7), 0x4 }, 
        { MSDC_HS200_MODE, 0xb0,  (0x1f<<10), 0x0 }, 
        { MSDC_HS400_MODE, 0xb0,  (0x7 << 7), 0x14 }, 
        { MSDC_HS400_MODE, 0xb0,  (0x1f<<10), 0x0 }, 
        { MSDC_HS400_MODE, 0x188, (0x1f<< 2), 0xb }, 
        { MSDC_HS400_MODE, 0x188, (0x1f<<12), 0x1a }, 

        
        { MSDC_HS200_MODE, 0xb4,  (0x7 << 3), 0x0 }, 
        { MSDC_HS200_MODE, 0x4,   (0x1 << 1), 0x2 }, 
        { MSDC_HS200_MODE, 0xec,  (0x1f<<16), 0x0 }, 
        { MSDC_HS200_MODE, 0xec,  (0x1f<<22), 0x1 }, 

        { MSDC_HS400_MODE, 0xb4,  (0x7 << 3), 0x0 }, 
        { MSDC_HS400_MODE, 0x4,   (0x1 << 1), 0x11 }, 
        { MSDC_HS400_MODE, 0xec,  (0x1f<<16), 0x0 }, 
        { MSDC_HS400_MODE, 0xec,  (0x1f<<22), 0x1 }, 

        
        { MSDC_HS200_MODE, 0xb4,  (0x7 << 0), 0x0 }, 
        { MSDC_HS200_MODE, 0xec,  (0x1f<< 0), 0x1 }, 
        { MSDC_HS200_MODE, 0x4,   (0x1 <<10), 0x2 }, 
        { MSDC_HS200_MODE, 0xf0,  (0x1f<<24), 0x0 }, 

        
        { MSDC_HS200_MODE, 0xec,  (0x1f<< 8), 0x0 }, 
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .cmd_drv_sd_18        = 2,
        .dat_drv_sd_18        = 2,
        .clk_drv_sd_18_sdr50	= 2,         
        .cmd_drv_sd_18_sdr50	= 2,
        .dat_drv_sd_18_sdr50	= 2,
        .clk_drv_sd_18_ddr50	= 2,         
        .cmd_drv_sd_18_ddr50	= 2,
        .dat_drv_sd_18_ddr50	= 2,
        .clk_drv_sd_18_sdr104	= 2,         
        .cmd_drv_sd_18_sdr104	= 2,
        .dat_drv_sd_18_sdr104	= 2,
        .data_pins            = 4,
        .data_offset          = 0,
        .flags                = MSDC_SDIO_FLAG,
        .dat0rddly            = 0,
