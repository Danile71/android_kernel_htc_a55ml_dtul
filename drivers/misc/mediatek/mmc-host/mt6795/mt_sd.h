...
#define MAX_HS400_TUNE_COUNT (576) 
#endif 
...
#define MSDC_EMMC_BOOTMODE0     (0)	
#define MSDC_EMMC_BOOTMODE1     (1)	
...
#define MSDC_CFG_CKDIV          (0xff << 8)	
#define MSDC_CFG_CKMOD          (0x3  << 16)	
#define MSDC_CFG_CKMOD_HS400    (0x1  << 18)	
#define MSDC_CFG_START_BIT      (0x3  << 19)	
#define MSDC_CFG_SCLK_STOP_DDR  (0x1  << 21)	

#define MSDC_IOCON_SDR104CKS    (0x1  << 0)	
#define MSDC_IOCON_RSPL         (0x1  << 1)	
#define MSDC_IOCON_R_D_SMPL         (0x1  << 2)	
#define MSDC_IOCON_DDLSEL       (0x1  << 3)	
#define MSDC_IOCON_DDR50CKD     (0x1  << 4)	
#define MSDC_IOCON_R_D_SMPL_SEL      (0x1  << 5)	
#define MSDC_IOCON_W_D_SMPL     (0x1  << 8)	
#define MSDC_IOCON_W_D_SMPL_SEL (0x1  << 9)	
#define MSDC_IOCON_W_D0SPL      (0x1  << 10)	
#define MSDC_IOCON_W_D1SPL      (0x1  << 11)	
#define MSDC_IOCON_W_D2SPL      (0x1  << 12)	
#define MSDC_IOCON_W_D3SPL      (0x1  << 13)	
#define MSDC_IOCON_R_D0SPL        (0x1  << 16)	
#define MSDC_IOCON_R_D1SPL        (0x1  << 17)	
#define MSDC_IOCON_R_D2SPL        (0x1  << 18)	
#define MSDC_IOCON_R_D3SPL        (0x1  << 19)	
#define MSDC_IOCON_R_D4SPL        (0x1  << 20)	
#define MSDC_IOCON_R_D5SPL        (0x1  << 21)	
#define MSDC_IOCON_R_D6SPL        (0x1  << 22)	
#define MSDC_IOCON_R_D7SPL        (0x1  << 23)	
#define MSDC_IOCON_RISCSZ       (0x3  << 24)	

#define MSDC_PS_CDEN            (0x1  << 0)	
#define MSDC_PS_CDSTS           (0x1  << 1)	
#define MSDC_PS_CDDEBOUNCE      (0xf  << 12)	
#define MSDC_PS_DAT             (0xff << 16)	
#define MSDC_PS_CMD             (0x1  << 24)	
#define MSDC_PS_WP              (0x1UL<< 31)    
...
#define MSDC_INT_ACMD19_DONE    (0x1  << 16)	
#define MSDC_INT_BDCSERR        (0x1  << 17)	
#define MSDC_INT_GPDCSERR       (0x1  << 18)	
#define MSDC_INT_DMAPRO         (0x1  << 19)	
#define MSDC_INT_AXI_RESP_ERR   (0x1  << 23)	
#if defined(MTK_SDIO30_ONLINE_TUNING_SUPPORT) || defined(ONLINE_TUNING_DVTTEST)
#define MSDC_INT_GEAR_OUT_BOUND (0x1  << 20)	
#define MSDC_INT_ACMD53_DONE    (0x1  << 21)	
#define MSDC_INT_ACMD53_FAIL    (0x1  << 22)	
#endif				

#define MSDC_INTEN_MMCIRQ       (0x1  << 0)	
#define MSDC_INTEN_CDSC         (0x1  << 1)	
#define MSDC_INTEN_ACMDRDY      (0x1  << 3)	
#define MSDC_INTEN_ACMDTMO      (0x1  << 4)	
#define MSDC_INTEN_ACMDCRCERR   (0x1  << 5)	
#define MSDC_INTEN_DMAQ_EMPTY   (0x1  << 6)	
#define MSDC_INTEN_SDIOIRQ      (0x1  << 7)	
#define MSDC_INTEN_CMDRDY       (0x1  << 8)	
#define MSDC_INTEN_CMDTMO       (0x1  << 9)	
#define MSDC_INTEN_RSPCRCERR    (0x1  << 10)	
#define MSDC_INTEN_CSTA         (0x1  << 11)	
#define MSDC_INTEN_XFER_COMPL   (0x1  << 12)	
#define MSDC_INTEN_DXFER_DONE   (0x1  << 13)	
#define MSDC_INTEN_DATTMO       (0x1  << 14)	
#define MSDC_INTEN_DATCRCERR    (0x1  << 15)	
#define MSDC_INTEN_ACMD19_DONE  (0x1  << 16)	
#define MSDC_INTEN_BDCSERR      (0x1  << 17)	
#define MSDC_INTEN_GPDCSERR     (0x1  << 18)	
#define MSDC_INTEN_DMAPRO       (0x1  << 19)	
#define MSDC_INTEN_GOBOUND      (0x1  << 20)	
#define MSDC_INTEN_ACMD53_DONE  (0x1  << 21)	
#define MSDC_INTEN_ACMD53_FAIL  (0x1  << 22)	
#define MSDC_INTEN_AXI_RESP_ERR (0x1  << 23)	
...
#define SDC_CFG_SDIOINTWKUP     (0x1  << 0)	
#define SDC_CFG_INSWKUP         (0x1  << 1)	
#define SDC_CFG_BUSWIDTH        (0x3  << 16)	
#define SDC_CFG_SDIO            (0x1  << 19)	
#define SDC_CFG_SDIOIDE         (0x1  << 20)	
#define SDC_CFG_INTATGAP        (0x1  << 21)	
...
#define SDC_CMD_GOIRQ           (0x1  << 15)	
#define SDC_CMD_BLKLEN          (0xfff << 16)	
#define SDC_CMD_AUTOCMD         (0x3  << 28)	
#define SDC_CMD_VOLSWTH         (0x1  << 30)	
#define SDC_CMD_ACMD53          (0x1UL  << 31)	

#define SDC_STS_SDCBUSY         (0x1  << 0)	
#define SDC_STS_CMDBUSY         (0x1  << 1)	
#define SDC_STS_SWR_COMPL       (0x1UL  << 31)	

#define SDC_DCRC_STS_NEG        (0xff << 8)	
#define SDC_DCRC_STS_POS        (0xff << 0)	

#define EMMC_CFG0_BOOTSTART     (0x1  << 0)	
#define EMMC_CFG0_BOOTSTOP      (0x1  << 1)	
#define EMMC_CFG0_BOOTMODE      (0x1  << 2)	
#define EMMC_CFG0_BOOTACKDIS    (0x1  << 3)	
#define EMMC_CFG0_BOOTWDLY      (0x7  << 12)	
#define EMMC_CFG0_BOOTSUPP      (0x1  << 15)	

#define EMMC_CFG1_BOOTDATTMC    (0xfffff << 0)	
#define EMMC_CFG1_BOOTACKTMC    (0xfffUL << 20) 

#define EMMC_STS_BOOTCRCERR     (0x1  << 0)	
#define EMMC_STS_BOOTACKERR     (0x1  << 1)	
#define EMMC_STS_BOOTDATTMO     (0x1  << 2)	
#define EMMC_STS_BOOTACKTMO     (0x1  << 3)	
#define EMMC_STS_BOOTUPSTATE    (0x1  << 4)	
#define EMMC_STS_BOOTACKRCV     (0x1  << 5)	
#define EMMC_STS_BOOTDATRCV     (0x1  << 6)	

#define EMMC_IOCON_BOOTRST      (0x1  << 0)	

#define SDC_ACMD19_TRG_TUNESEL  (0xf  << 0)	

#define MSDC_DMA_CTRL_START     (0x1  << 0)	
#define MSDC_DMA_CTRL_STOP      (0x1  << 1)	
#define MSDC_DMA_CTRL_RESUME    (0x1  << 2)	
#define MSDC_DMA_CTRL_MODE      (0x1  << 8)	
#define MSDC_DMA_CTRL_LASTBUF   (0x1  << 10)	
#define MSDC_DMA_CTRL_BRUSTSZ   (0x7  << 12)	

#define MSDC_DMA_CFG_STS        (0x1  << 0)	
#define MSDC_DMA_CFG_DECSEN     (0x1  << 1)	
#define MSDC_DMA_CFG_AHBEN      (0x3  << 8)	
#define MSDC_DMA_CFG_ACTEN      (0x3  << 12)	
#define MSDC_DMA_CFG_CS12B      (0x1  << 16)	
#define MSDC_DMA_CFG_OUTB_STOP  (0x1  << 17)	

    
#define MSDC_PATCH_BIT_ODDSUPP    (0x1  <<  1)	
...
#define MSDC_PAD_TUNE_DATWRDLY  (0x1F << 0)	
#define MSDC_PAD_TUNE_DATRRDLY  (0x1F << 8)	
#define MSDC_PAD_TUNE_CMDRDLY   (0x1F << 16)	
#define MSDC_PAD_TUNE_CMDRRDLY  (0x1F << 22)	
#define MSDC_PAD_TUNE_CLKTXDLY  (0x1FUL << 27)	

#define MSDC_DAT_RDDLY0_D3      (0x1F << 0)	
#define MSDC_DAT_RDDLY0_D2      (0x1F << 8)	
#define MSDC_DAT_RDDLY0_D1      (0x1F << 16)	
#define MSDC_DAT_RDDLY0_D0      (0x1F << 24)	

#define MSDC_DAT_RDDLY1_D7      (0x1F << 0)	
#define MSDC_DAT_RDDLY1_D6      (0x1F << 8)	
#define MSDC_DAT_RDDLY1_D5      (0x1F << 16)	
#define MSDC_DAT_RDDLY1_D4      (0x1F << 24)	
...
struct msdc_regs {
	msdc_cfg_reg msdc_cfg;	
	msdc_iocon_reg msdc_iocon;	
	msdc_ps_reg msdc_ps;	
	msdc_int_reg msdc_int;	
	msdc_inten_reg msdc_inten;	
	msdc_fifocs_reg msdc_fifocs;	
	msdc_txdat_reg msdc_txdat;	
	msdc_rxdat_reg msdc_rxdat;	
	u32 rsv1[4];
	sdc_cfg_reg sdc_cfg;	
	sdc_cmd_reg sdc_cmd;	
	sdc_arg_reg sdc_arg;	
	sdc_sts_reg sdc_sts;	
	sdc_resp0_reg sdc_resp0;	
	sdc_resp1_reg sdc_resp1;	
	sdc_resp2_reg sdc_resp2;	
	sdc_resp3_reg sdc_resp3;	
	sdc_blknum_reg sdc_blknum;	
	u32 rsv2[1];
	sdc_csts_reg sdc_csts;	
	sdc_cstsen_reg sdc_cstsen;	
	sdc_datcrcsts_reg sdc_dcrcsta;	
	u32 rsv3[3];
	emmc_cfg0_reg emmc_cfg0;	
	emmc_cfg1_reg emmc_cfg1;	
	emmc_sts_reg emmc_sts;	
	emmc_iocon_reg emmc_iocon;	
	msdc_acmd_resp_reg acmd_resp;	
	msdc_acmd19_trg_reg acmd19_trg;	
	msdc_acmd19_sts_reg acmd19_sts;	
	u32 rsv4[1];
	msdc_dma_sa_reg dma_sa;	
	msdc_dma_ca_reg dma_ca;	
	msdc_dma_ctrl_reg dma_ctrl;	
	msdc_dma_cfg_reg dma_cfg;	
	msdc_dbg_sel_reg dbg_sel;	
	msdc_dbg_out_reg dbg_out;	
	u32 rsv5[2];
	u32 patch0;		
	u32 patch1;		
	u32 rsv6[10];
	msdc_pad_ctl0_reg pad_ctl0;	
	msdc_pad_ctl1_reg pad_ctl1;	
	msdc_pad_ctl2_reg pad_ctl2;	
	msdc_pad_tune_reg pad_tune;	
	msdc_dat_rddly0 dat_rddly0;	
	msdc_dat_rddly1 dat_rddly1;	
	msdc_hw_dbg_reg hw_dbg;	
	u32 rsv7[1];
	msdc_version_reg version;	
	msdc_eco_ver_reg eco_ver;	
};
