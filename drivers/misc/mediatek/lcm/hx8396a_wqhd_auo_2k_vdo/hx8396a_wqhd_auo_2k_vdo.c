...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->pwm_min = 6;
	params->pwm_default = 66;
	params->pwm_max = 213;
	params->camera_blk = 197;
	params->camera_dua_blk = 197;
	params->dim_cmd = 0x2c;
}
